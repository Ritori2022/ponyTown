...
describe('ponyInfo', () => {
    describe('syncLockedSpriteSet()', () => {
        it('does nothing for undefined', () => {
            (0, ponyInfo_1.syncLockedSpriteSet)(undefined, false, f => f, 'ff0000', '00ff00');
        });
        it('does nothing for missing fills', () => {
            (0, ponyInfo_1.syncLockedSpriteSet)({}, false, f => f, 'ff0000', '00ff00');
        });
        it('does nothing for missing lockFills', () => {
            (0, ponyInfo_1.syncLockedSpriteSet)({ fills: ['00ff00'] }, false, f => f, 'ff0000', '00ff00');
        });
        it('uses base fill if fill is locked', () => {
            ...
            (0, ponyInfo_1.syncLockedSpriteSet)(set, false, f => f, 'ff0000', '00ff00');
            (0, chai_1.expect)(set.fills[0]).equal('ff0000');
        });
        it('uses first fill if fill is locked', () => {
            ...
            (0, ponyInfo_1.syncLockedSpriteSet)(set, false, f => f, 'ffffff', '000000');
            (0, chai_1.expect)(set.fills).eql(['ff0000', 'ff0000', '0000ff']);
        });
        it('uses generated outline if custom outlines is false', () => {
            ...
            (0, ponyInfo_1.syncLockedSpriteSet)(set, false, f => f + 'x', 'ff0000', '00ff00');
            (0, chai_1.expect)(set.lockOutlines).eql([true, true]);
            (0, chai_1.expect)(set.outlines).eql(['ff0000x', '00ff00x']);
        });
        it('uses generated outline if outline is locked', () => {
            ...
            (0, ponyInfo_1.syncLockedSpriteSet)(set, true, f => f + 'x', 'ff0000', '00ff00');
            (0, chai_1.expect)(set.outlines).eql(['000000', '00ff00x']);
        });
        it('uses base outline for first fill if fill is locked too', () => {
            ...
            (0, ponyInfo_1.syncLockedSpriteSet)(set, true, f => f + 'x', 'ff0000', 'ffffff');
            (0, chai_1.expect)(set.outlines).eql(['ffffff', '000000']);
        });
    });
    describe('syncLockedPonyInfo()', () => {
        it('syncs coatOutline if customOutlines is false', () => {
            ...
            (0, ponyInfo_1.syncLockedPonyInfo)(pony);
            (0, chai_1.expect)(pony.coatOutline).equal('b30000');
        });
        ...
        it('does not sync coatOutline if customOutline is false and lockCoatOutline is false', () => {
            ...
            (0, ponyInfo_1.syncLockedPonyInfo)(pony);
            (0, chai_1.expect)(pony.coatOutline).equal('00ff00');
        });
        it('syncs eyeOpennessLeft if lockEyes is true', () => {
            ...
            (0, ponyInfo_1.syncLockedPonyInfo)(pony);
            (0, chai_1.expect)(pony.eyeOpennessLeft).equal(2);
        });
        it('does not sync eyeOpennessLeft if lockEyes is false', () => {
            ...
            (0, ponyInfo_1.syncLockedPonyInfo)(pony);
            (0, chai_1.expect)(pony.eyeOpennessLeft).equal(3);
        });
        it('syncs eyeColorLeft if lockEyeColor is true', () => {
            ...
            (0, ponyInfo_1.syncLockedPonyInfo)(pony);
            (0, chai_1.expect)(pony.eyeColorLeft).equal('00ff00');
        });
        it('does not sync eyeColorLeft if lockEyeColor is false', () => {
            ...
            (0, ponyInfo_1.syncLockedPonyInfo)(pony);
            (0, chai_1.expect)(pony.eyeColorLeft).equal('ff0000');
        });
        const fields = [
        ...
        fields.forEach(field => it(`syncs '${field}' sprite set`, () => {
            ...
            (0, ponyInfo_1.syncLockedPonyInfo)(pony);
            (0, chai_1.expect)(pony[field]).eql({
                fills: ['ff0000'],
                outlines: ['b30000'],
                lockOutlines: [true],
            });
        ...
        it('syncs extraAccessory colors to correct pony colors', () => {
            const pony = ponyInfo({
                ...
                extraAccessory: {
                    fills: (0, utils_1.repeat)(5, '111111'),
                    lockFills: (0, utils_1.repeat)(5, true),
                    outlines: (0, utils_1.repeat)(5, '111111'),
                    lockOutlines: (0, utils_1.repeat)(5, true),
                },
            });
            (0, ponyInfo_1.syncLockedPonyInfo)(pony);
            (0, chai_1.expect)(pony.extraAccessory).eql({
    ...
    describe('syncLockedPonyInfoNumber()', () => {
        it('syncs coatOutline if customOutlines is false', () => {
            ...
            (0, chai_1.expect)(pony.coatOutline).equal(0xb30000ff);
        });
    });
    describe('toPaletteSet()', () => {
        const getColorsForSet = (set, count) => new Uint32Array([
            colors_1.TRANSPARENT,
            ...(0, utils_1.flatten)((0, utils_1.times)(count, i => [
        ...
        it('returns default object for empty set', () => {
            (0, chai_1.expect)((0, ponyInfo_1.toPaletteSet)({}, undefined, manager, getColorsForSet, false, true)).eql({
                type: 0,
                pattern: 0,
        ...
        it('returns type pattern and palette fields from set', () => {
            ...
            (0, chai_1.expect)((0, ponyInfo_1.toPaletteSet)(set, [], manager, getColorsForSet, false, true)).eql({
                type: 1,
                pattern: 2,
                palette: [colors_1.TRANSPARENT],
                extraPalette: undefined,
        ...
        it('trims palette to set color count', () => {
            ...
            (0, chai_1.expect)((0, ponyInfo_1.toPaletteSet)(set, sets, manager, getColorsForSet, false, true)).eql({
                type: 1,
                pattern: 2,
        ...
        it('returns extra palette from sets', () => {
            ...
            (0, chai_1.expect)((0, ponyInfo_1.toPaletteSet)(set, sets, manager, getColorsForSet, true, true)).eql({
                type: 0,
                pattern: 0,
                palette: [colors_1.TRANSPARENT],
    ...
    describe('releasePalettes()', () => {
        it('ignores other fields', () => {
            (0, ponyInfo_1.releasePalettes)({ foo: 'bar', bar: 12, test: { a: 4 } });
        });
        it('releases palette field', () => {
            const palette = { refs: 1, x: 0, y: 0, u: 0, v: 0, colors: new Uint32Array(0) };
            (0, ponyInfo_1.releasePalettes)({ foo: palette });
            (0, chai_1.expect)(palette.refs).equal(0);
        });
        it('releases palette in object field', () => {
            const palette = { refs: 1, x: 0, y: 0, u: 0, v: 0, colors: new Uint32Array(0) };
            const extraPalette = { refs: 1, x: 0, y: 0, u: 0, v: 0, colors: new Uint32Array(0) };
            (0, ponyInfo_1.releasePalettes)({ foo: { palette, extraPalette } });
            (0, chai_1.expect)(palette.refs).equal(0);
            (0, chai_1.expect)(extraPalette.refs).equal(0);
        });
    });
});
