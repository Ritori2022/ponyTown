...
const collision = tslib_1.__importStar(require("../../common/collision"));
describe('move', () => {
    describe('move()', () => {
        let camera;
        let client;
        let counter = (0, lib_1.stubClass)(counter_1.CounterService);
        let move;
        let isStaticCollision;
        beforeEach(() => {
            (0, lib_1.resetStubMethods)(counter, 'add', 'remove');
            isStaticCollision = (0, sinon_1.stub)(collision, 'isStaticCollision');
            camera = (0, camera_1.createCamera)();
            client = (0, mocks_1.mockClient)();
            client.map = (0, serverMap_1.createServerMap)('', 0, 10, 10);
            move = (0, move_1.createMove)(counter);
        });
        afterEach(() => {
        ...
        it('does nothing if loading flag is true', () => {
            ...
            (0, chai_1.expect)(client.pony.x).equal(0, 'x');
            (0, chai_1.expect)(client.pony.y).equal(0, 'y');
        });
        ...
        it('updates pony coordinates', () => {
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(12, 34, 2, 0 /* EntityState.None */, 123, camera);
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.pony.x).equal(12.015625, 'x');
            (0, chai_1.expect)(client.pony.y).equal(34.020833333333336, 'y');
        });
        it('updates last coordinates, velocity and time', () => {
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(12, 34, 2, 0 /* EntityState.None */, 123, camera);
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.lastX).equal(12.015625, 'lastX');
            (0, chai_1.expect)(client.lastY).equal(34.020833333333336, 'lastY');
            (0, chai_1.expect)(client.lastVX).equal(0, 'lastVX');
            (0, chai_1.expect)(client.lastVY).equal(0, 'lastVY');
            (0, chai_1.expect)(client.lastTime).equal(123, 'lastTime');
        });
        ...
        it('updates pony velocity', () => {
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(12, 34, 2, 32 /* EntityState.PonyTrotting */, 123, camera);
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.pony.vx).equal(constants_1.PONY_SPEED_TROT, 'vx');
            (0, chai_1.expect)(client.pony.vy).equal(-constants_1.PONY_SPEED_TROT, 'vy');
        });
        it('updates safe position if not colliding', () => {
            ...
            client.pony.y = 30;
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.safeX).equal(10, 'safeX');
            (0, chai_1.expect)(client.safeY).equal(30, 'safeY');
        ...
        it('does not update safe position if colliding', () => {
            ...
            client.safeY = 3;
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.safeX).equal(1, 'safeX');
            (0, chai_1.expect)(client.safeY).equal(3, 'safeY');
        });
        it('resets pony to safe position if colliding', () => {
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(12, 34, 2, 32 /* EntityState.PonyTrotting */, 123, camera);
            const fixPositionStub = (0, sinon_1.stub)(client, 'fixPosition');
            ...
            client.safeY = 3;
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.pony.x).equal(1, 'x');
            (0, chai_1.expect)(client.pony.y).equal(3, 'y');
        ...
        it('updates pony right flag', () => {
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(12, 34, 2, 32 /* EntityState.PonyTrotting */, 123, camera);
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.pony.state).equal(2 /* EntityState.FacingRight */, 'flags');
        });
        it('resets head turned flag if turning', () => {
            client.pony.state = 4 /* EntityState.HeadTurned */;
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(12, 34, 2, 32 /* EntityState.PonyTrotting */, 123, camera);
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.pony.state).equal(2 /* EntityState.FacingRight */, 'flags');
        });
        ...
        it('adds entity update', () => {
            ...
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(0, 0, 0, 0, 0, (0, rect_1.rect)(0, 0, 0, 0));
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(region.entityUpdates).eql([
                {
                    entity: client.pony, flags: 1 /* UpdateFlags.Position */ | 4 /* UpdateFlags.State */,
        ...
        it('clears cancellable expression', () => {
            ...
            (0, chai_1.expect)(client.pony.exprCancellable).false;
        });
        it('reports client outside the map', () => {
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(10000, 10000, 0, 0 /* EntityState.None */, 123, camera);
        ...
        it('logs client outside the map', () => {
            ...
            Object.assign(client.map, { id: 'foo', width: 100, height: 100 });
            move(client, 0, a, b, c, d, e, {});
            (0, chai_1.expect)(client.leaveReason).equal('outside map: [foo] coords: [10000.02, 10000.02]');
        });
        ...
        it('logs lagging player if logLagging setting is true', () => {
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(12, 34, 2, 32 /* EntityState.PonyTrotting */, 16000, camera);
            ...
            (0, chai_1.expect)(client.logDisconnect).true;
        });
        it('kicks player for lagging if kickLagging setting is true', () => {
            ...
            sinon_1.assert.calledWith(disconnect, true, true);
            (0, chai_1.expect)(client.leaveReason).equal('lagging');
        });
        it('counts teleporting', () => {
            const [a, b, c, d, e] = (0, movementUtils_1.encodeMovement)(10, 10, 2, 32 /* EntityState.PonyTrotting */, 1001, camera);
        ...
        it('kicks player for teleporting', () => {
            ...
            sinon_1.assert.calledWith(disconnect, true, true);
            (0, chai_1.expect)(client.leaveReason).equal('teleporting');
        });
        it('fixes player position if teleporting', () => {
            ...
            (0, chai_1.expect)(client.pony.vx).equal(0);
            (0, chai_1.expect)(client.pony.vy).equal(0);
