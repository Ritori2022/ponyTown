...
exports.POSITION_MAX = exports.POSITION_MIN = void 0;
...
function flagsToSpeed(flags) {
    const state = flags & 240 /* EntityState.PonyStateMask */;
    if (state === 32 /* EntityState.PonyTrotting */) {
        return constants_1.PONY_SPEED_TROT;
    }
    else if (state === 16 /* EntityState.PonyWalking */) {
...
function encodeMovement(x, y, dir, flags, time, camera) {
    const pixelX = Math.floor((0, utils_1.clamp)(x, exports.POSITION_MIN, exports.POSITION_MAX) * constants_1.tileWidth);
    const pixelY = Math.floor((0, utils_1.clamp)(y, exports.POSITION_MIN, exports.POSITION_MAX) * constants_1.tileHeight);
...
function decodeMovement(a, b, c, d, e) {
    ...
    const x = (0, positionUtils_1.toWorldX)(pixelX + 0.5);
    const y = (0, positionUtils_1.toWorldY)(pixelY + 0.5);
    const dir = (a >>> 24) & 0xff;
    ...
    const camH = e & 0xfff;
    return { x, y, dir, flags, time, camera: (0, rect_1.rect)(camX, camY, camW, camH) };
}
function isMovingRight(vx, right) {
    return vx < 0 ? false : (vx > 0 ? true : right);
}
function shouldBeFacingRight(entity) {
    return isMovingRight(entity.vx, (0, utils_1.hasFlag)(entity.state, 2 /* EntityState.FacingRight */));
}
