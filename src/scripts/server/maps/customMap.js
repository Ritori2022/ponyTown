...
const mapData = JSON.parse(fs.readFileSync((0, paths_1.pathTo)('src', 'maps', 'custom.json'), 'utf8'));
function createCustomMap(world) {
    // size: 4 by 4 regions -> 32 by 32 tiles
    // default tiles: grass
    const map = (0, serverMap_1.createServerMap)('custom', 0 /* MapType.None */, 4, 4, 2 /* TileType.Grass */);
    // initialize tiles
    ...
    add((0, controllerUtils_1.createSign)(map.width / 2, map.height / 2 - 2, 'Go back', (_, client) => (0, world_1.goToMap)(world, client, '', 'center')));
