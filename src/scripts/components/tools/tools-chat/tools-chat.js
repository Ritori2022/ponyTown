...
let ToolsChat = class ToolsChat {
    constructor() {
        ...
        this.messages = [
            { label: 'Chat message', color: (0, colors_1.getMessageColor)(0 /* MessageType.Chat */) },
            { label: 'System message', color: (0, colors_1.getMessageColor)(1 /* MessageType.System */) },
            { label: 'Admin message', color: (0, colors_1.getMessageColor)(2 /* MessageType.Admin */) },
            { label: 'Mod message', color: (0, colors_1.getMessageColor)(3 /* MessageType.Mod */) },
            { label: 'Announcement message', color: (0, colors_1.getMessageColor)(7 /* MessageType.Announcement */) },
            { label: 'Party message', color: (0, colors_1.getMessageColor)(4 /* MessageType.Party */) },
            { label: 'Thinking message', color: (0, colors_1.getMessageColor)(5 /* MessageType.Thinking */) },
            { label: 'PartyThinking message', color: (0, colors_1.getMessageColor)(6 /* MessageType.PartyThinking */) },
            { label: 'PartyAnnouncement message', color: (0, colors_1.getMessageColor)(8 /* MessageType.PartyAnnouncement */) },
            // {
            ...
            { label: 'Supporter message 1', color: (0, colors_1.getMessageColor)(9 /* MessageType.Supporter1 */) },
    ...
    redraw() {
        if (!this.initialized)
            return;
        const canvas1 = (0, contextSpriteBatch_1.drawCanvas)(500, 400, sprites.paletteSpriteSheet, undefined, batch => {
            ...
            this.messages.forEach(({ label, color, palette }, index) => {
                const size = (0, spriteFont_1.measureText)(label, fonts_1.fontPal);
                const options = { palette: palette ? palette(palettes.mainFont) : palettes.mainFont.white };
                (0, graphicsUtils_1.drawSpeechBaloon)(batch, label, color, options, 10 + size.w / 2, 20 + 20 * index, size.w, size.h, 1, 5);
            });
            this.names.forEach(({ label, color, font }, index) => {
                ...
                (0, spriteFont_1.drawOutlinedText)(batch, label, font(), color, colors_1.OUTLINE_COLOR, 190, 10 + 15 * index, { palette });
            });
            // ---
            (0, spriteFont_1.drawOutlinedText)(batch, '<SUPPORTER>', fonts_1.fontSmallPal, colors_1.PATREON_COLOR, colors_1.OUTLINE_COLOR, 190, 120, { palette: palettes.smallFont.white });
            // names
            (0, graphicsUtils_1.drawNamePlate)(batch, 'Some name 1', 220, 150, graphicsUtils_1.DrawNameFlags.None, palettes, 'sup1');
            (0, graphicsUtils_1.drawNamePlate)(batch, 'Some name 2', 220, 175, graphicsUtils_1.DrawNameFlags.None, palettes, 'sup2');
            (0, graphicsUtils_1.drawNamePlate)(batch, 'Some name 3', 220, 200, graphicsUtils_1.DrawNameFlags.None, palettes, 'sup3');
            // speech baloons
            (0, graphicsUtils_1.drawBaloon)(batch, { message: 'regular baloon', type: 0 /* MessageType.Chat */, created: 0 }, 50, 300, (0, rect_1.rect)(0, 0, 1000, 1000), palettes);
            (0, graphicsUtils_1.drawBaloon)(batch, { message: 'thinking baloon', type: 5 /* MessageType.Thinking */, created: 0 }, 50, 330, (0, rect_1.rect)(0, 0, 1000, 1000), palettes);
            (0, graphicsUtils_1.drawBaloon)(batch, { message: 'whisper baloon', type: 13 /* MessageType.Whisper */, created: 0 }, 50, 360, (0, rect_1.rect)(0, 0, 1000, 1000), palettes);
        });
        const canvas2 = (0, contextSpriteBatch_1.drawCanvas)(500, 400, sprites.paletteSpriteSheet, undefined, batch => {
            ...
            (0, spriteFont_1.drawText)(batch, 'Lorem 🍎 ipsum', fonts_1.fontPal, colors_1.WHITE, 10, 150, { palette, emojiPalette });
            const palette1 = ponyInfo_1.mockPaletteManager.addArray(sprites.fontSupporter1Palette);
            (0, spriteFont_1.drawText)(batch, '<SUPPÓĄRTER>', fonts_1.fontSmallPal, colors_1.WHITE, 20, 180, { palette: palette1 });
            const palette2 = ponyInfo_1.mockPaletteManager.addArray(sprites.fontSupporter2Palette);
            (0, spriteFont_1.drawText)(batch, '<SUPPÓĄRTER>', fonts_1.fontSmallPal, colors_1.WHITE, 20, 195, { palette: palette2 });
            ...
            (0, spriteFont_1.drawText)(batch, '<SUPPÓĄ⚧RTER>', fonts_1.fontSmallPal, colors_1.WHITE, 20, 210, { palette: palette3 });
        });
        const canvas3 = (0, contextSpriteBatch_1.drawCanvas)(500, 400, sprites.paletteSpriteSheet, undefined, batch => {
            /* tslint:disable */
            ...
            const text = (0, spriteFont_1.lineBreak)(loremIpsum, fonts_1.fontPal, 200);
            batch.drawRect(colors_1.WHITE, 10, 10, 200, 100);
            (0, spriteFont_1.drawText)(batch, text, fonts_1.fontPal, colors_1.BLACK, 10, 10);
            const bounds = (0, rect_1.rect)(10 + 200 + 20, 10, 200, 100);
            batch.drawRect(colors_1.WHITE, bounds.x, bounds.y, bounds.w, bounds.h);
            (0, spriteFont_1.drawTextAligned)(batch, text, fonts_1.fontPal, colors_1.BLACK, bounds, 1 /* HAlign.Right */);
            const bounds2 = (0, rect_1.rect)(10 + 200 + 20, 10 + 120, 200, 20);
            batch.drawRect(colors_1.WHITE, bounds2.x, bounds2.y, bounds2.w, bounds2.h);
            (0, spriteFont_1.drawTextAligned)(batch, 'test text', fonts_1.fontPal, colors_1.BLACK, bounds2, 1 /* HAlign.Right */);
        });
        const canvas = this.element.nativeElement;
        const context = canvas.getContext('2d');
        context.fillStyle = (0, color_1.colorToCSS)(this.bg);
...
exports.ToolsChat = ToolsChat = tslib_1.__decorate([
    (0, core_1.Component)({
        selector: 'tools-chat',
