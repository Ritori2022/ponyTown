...
class ClientActions {
    ...
    connected() {
        (0, gameUtils_1.resetGameFields)(this.game);
        this.game.map = (0, worldMap_1.createWorldMap)();
        this.game.player = undefined;
        this.game.joined();
        this.apply(() => this.gameService.joined());
        const supportsWasm = typeof WebAssembly !== 'undefined';
        const info = 0 |
            (clientUtils_1.isInIncognitoMode ? 1 /* InfoFlags.Incognito */ : 0) |
            (supportsWasm ? 2 /* InfoFlags.SupportsWASM */ : 0) |
            ((0, clientUtils_1.supportsLetAndConst)() ? 4 /* InfoFlags.SupportsLetAndConst */ : 0);
        this.game.send(server => server.actionParam2(20 /* Action.Info */, info));
    }
    disconnected() {
        (0, gameUtils_1.resetGameFields)(this.game);
    ...
    mapState(info, state) {
        this.game.map = (0, worldMap_1.createWorldMap)(info, state);
        this.game.player = undefined;
        this.game.setupMap();
        (0, worldMap_1.updateMapState)(this.game.map, interfaces_1.defaultMapState, this.game.map.state);
    }
    mapUpdate(state) {
        const prevState = this.game.map.state;
        this.game.map.state = state;
        (0, worldMap_1.updateMapState)(this.game.map, prevState, this.game.map.state);
    }
    mapSwitching() {
    ...
    myEntity(id, name, info, characterId, crc) {
        ...
        const pony = (0, utils_1.findById)(this.model.ponies, characterId);
        if (pony) {
        ...
        const entity = (0, worldMap_1.findEntityById)(this.game.map, id);
        if (entity) {
            entity.name = name;
            (0, handlers_1.updatePonyInfoWithPoof)(this.game, entity, info, crc);
        }
        this.game.onActionsUpdate.next();
    }
    update(unsubscribes, subscribes, updates, regions, says) {
        (0, worldMap_1.removeRegions)(this.game.map, unsubscribes);
        for (const subscribe of subscribes) {
            (0, handlers_1.subscribeRegion)(this.game, subscribe);
        }
        if (subscribes.length) {
            (0, gameUtils_1.markGameAsLoaded)(this.game);
        }
        if (updates) {
            (0, handlers_1.handleUpdates)(this.game, updates);
        }
        for (const region of regions) {
            const { x, y, updates, removes, tiles } = (0, updateDecoder_1.decodeUpdate)(region);
            for (const update of updates) {
                (0, handlers_1.handleUpdateEntity)(this.game, update);
            }
            for (const id of removes) {
                (0, handlers_1.handleRemoveEntity)(this.game, id);
            }
            for (const tile of tiles) {
                (0, worldMap_1.setTileAtRegion)(this.game.map, x, y, tile.x, tile.y, tile.type);
            }
        }
        for (const [id, message, type] of says) {
            (0, handlers_1.handleSays)(this.game, id, message, type);
        }
    }
    ...
    addNotification(id, entityId, name, message, note, flags) {
        const defaultCharacter = (0, utils_1.hasFlag)(flags, 32 /* NotificationFlags.Supporter */) ? this.game.supporterPony : this.game.offlinePony;
        const pony = (entityId && findPonyById(this.game.map, entityId)) || defaultCharacter;
        const filteredName = (0, handlers_1.filterEntityName)(this.game, name, (0, utils_1.hasFlag)(flags, 128 /* NotificationFlags.NameBad */));
        message = message.replace(/#NAME#/g, (0, emoji_1.nameToHTML)(filteredName || ''));
        this.apply(() => (0, gameUtils_1.addNotification)(this.game, { id, message, note, pony, flags, open: false, fresh: true }));
    }
    removeNotification(id) {
        this.apply(() => (0, gameUtils_1.removeNotification)(this.game, id));
    }
    updateSelection(currentId, newId) {
        if ((0, gameUtils_1.isSelected)(this.game, currentId)) {
    ...
    updateParty(party) {
        const members = party && party.map(([id, flags]) => ({
            ...
            leader: (0, utils_1.hasFlag)(flags, 1 /* PartyFlags.Leader */),
            pending: (0, utils_1.hasFlag)(flags, 2 /* PartyFlags.Pending */),
            offline: (0, utils_1.hasFlag)(flags, 4 /* PartyFlags.Offline */),
        }));
        if (members) {
        ...
        this.apply(() => {
            this.game.party = (0, partyUtils_1.updateParty)(this.game.party, members);
            this.game.onPartyUpdate.next();
        });
    }
    updatePonies(ponies) {
        (0, handlers_1.handleUpdatePonies)(this.game, ponies);
    }
    updateFriends(friends, removeMissing) {
        (0, handlers_1.handleUpdateFriends)(this.game, friends, removeMissing);
    }
    entityInfo(id, name, crc, nameBad) {
        (0, handlers_1.handleEntityInfo)(this.game, id, name, crc, nameBad);
    }
    entityList(value) {
        if (DEVELOPMENT || BETA) {
...
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [browser_1.Bin.U32] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "queue", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [browser_1.Bin.Obj, browser_1.Bin.Bool] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Boolean]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "worldState", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [browser_1.Bin.Obj, browser_1.Bin.Obj] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "mapState", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [browser_1.Bin.Obj] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "mapUpdate", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "mapSwitching", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [browser_1.Bin.I32, browser_1.Bin.I32, browser_1.Bin.U8Array] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Number, Uint8Array]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "mapTest", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [BinEntityId, browser_1.Bin.Str, browser_1.Bin.Str, browser_1.Bin.Str, browser_1.Bin.U16] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, String, String, String, Number]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "myEntity", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [[browser_1.Bin.U8], [browser_1.Bin.U8Array], browser_1.Bin.U8Array, [browser_1.Bin.U8Array], BinSayDatas] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Array, Array, Uint8Array, Array, Array]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "update", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [browser_1.Bin.F32, browser_1.Bin.F32, browser_1.Bin.Bool] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Number, Boolean]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "fixPosition", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [BinEntityId, browser_1.Bin.U8, browser_1.Bin.Obj] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Number, Object]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "actionParam", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [browser_1.Bin.U8] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "left", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [BinNotificationId, BinEntityId, browser_1.Bin.Str, browser_1.Bin.Str, browser_1.Bin.Str, browser_1.Bin.U8] }),
    tslib_1.__metadata("design:type", Function),
...
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [BinNotificationId] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "removeNotification", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [BinEntityId, BinEntityId] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Number]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "updateSelection", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [[BinEntityId, browser_1.Bin.U8]] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Array]),
    tslib_1.__metadata("design:returntype", void 0)
], ClientActions.prototype, "updateParty", null);
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [[BinEntityId, browser_1.Bin.Obj, browser_1.Bin.U8Array, browser_1.Bin.U8Array, BinEntityPlayerState, browser_1.Bin.Bool]] }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Array]),
    tslib_1.__metadata("design:returntype", void 0)
...
tslib_1.__decorate([
    (0, browser_1.Method)({ binary: [BinEntityId, browser_1.Bin.Str, browser_1.Bin.U32, browser_1.Bin.Bool] }),
    tslib_1.__metadata("design:type", Function),
...
if (DEVELOPMENT) {
    (0, browser_1.getMethods)(ClientActions)
